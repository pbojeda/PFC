...
% ----------------------------------
	...
	\label{sub:nav_diseno_de_menus_de_navegacion}
		...
		\subsubsection{Menús de navegación de los médicos.} % (fold)
		...
		\newpage
		\subsubsection{Menús de navegación de los pacientes.} % (fold)
		...
		\newpage
		\subsubsection{Menús de navegación de los administradores.} % (fold)
		...
		\newpage
		\subsubsection{Menús de navegación de las fichas médicas.} % (fold)
		...
		\newpage
		\subsubsection{Menús de navegación generales.} % (fold)
